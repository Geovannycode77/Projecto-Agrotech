...
from .views import (
    ...
    RelatorioFinanceiroViewSet, get_gestor_financeiro_dashboard, get_animais_gestor, get_analise_lucros, get_todas_despesas
)
...
urlpatterns = [
    ...
    path('todas-despesas/', get_todas_despesas, name='gestor-todas-despesas'),
