    ...
    return (
      <div className="flex justify-center items-center h-96">
        <div className="text-center">
          ...
          <p className="text-gray-500">Carregando configurações de segurança...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500 mt-1">Gerencie as configurações de segurança do sistema</p>
      </div>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500">Receber email ao fazer login</p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                  type="checkbox"
              ...
              {activityLog.map((log, index) => (
                <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  <div>
                    ...
                    <p className="text-xs text-gray-500">Usuário: {log.user} • IP: {log.ip}</p>
                  </div>
