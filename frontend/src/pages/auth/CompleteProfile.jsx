...
export default function CompleteProfile() {
  ...
  const validatePhone = (phone) => {
    ...
    if (!/^[0-9]{9}$/.test(phone))
      return "Telefone deve ter 9 dígitos (ex: 912345678)";
    return "";
  };
  ...
  const validateDate = (date) => {
    ...
    if (selected > today) return "A data não pode ser futura";

    const minDate = new Date(today);
    minDate.setFullYear(minDate.getFullYear() - 120);
    if (selected < minDate) return "Data inválida";
    ...
    if (age < 18) return "Deve ter pelo menos 18 anos para se registar";
    return "";
  };
  ...
  const validateConfirmPassword = (confirm, password) => {
    if (!confirm) return "Confirme a password";
    if (confirm !== password) return "As passwords não coincidem";
    return "";
  };
    ...
    switch (role) {
      case "produtor":
        if (!profileData.fazenda_nome)
          return {
            field: "fazenda_nome",
            msg: "Nome da fazenda é obrigatório",
          };
        if (profileData.fazenda_nome.trim().length < 3)
          return {
            field: "fazenda_nome",
            msg: "Nome da fazenda deve ter pelo menos 3 caracteres",
          };
        break;
      case "veterinario":
        if (!profileData.especialidade)
          return { field: "especialidade", msg: "Especialidade é obrigatória" };
        if (profileData.especialidade.trim().length < 3)
          return {
            field: "especialidade",
            msg: "Especialidade deve ter pelo menos 3 caracteres",
          };
        if (!profileData.crmv)
          return { field: "crmv", msg: "CRMV é obrigatório" };
        break;
      case "funcionario":
        if (!profileData.setor)
          return { field: "setor", msg: "Setor de trabalho é obrigatório" };
        break;
      case "gestor_financeiro":
        if (!profileData.area_atuacao)
          return {
            field: "area_atuacao",
            msg: "Área de atuação é obrigatória",
          };
        break;
      default:
        return null;
    ...
    if (touched[id]) {
      ...
      switch (id) {
        ...
        case "confirm_password":
          error = validateConfirmPassword(value, profileData.password);
          break;
        default:
          break;
      }
  ...
  const handleBlur = (field) => {
    ...
    switch (field) {
      ...
      case "endereco":
        ...
        break;
      case "password":
        error = validatePassword(profileData.password);
        break;
      case "confirm_password":
  ...
  const validateForm = () => {
    ...
    const passwordValue = profileData.password || userData.password || "";
    const confirmPasswordValue =
      profileData.confirm_password || userData.password || "";

    newErrors.password = validatePassword(passwordValue);
    ...
    if (roleError) newErrors[roleError.field] = roleError.msg;
  ...
  const handleSubmit = async (e) => {
    ...
    const submitData = {
      ...
      role: role,
      password: profileData.password || userData.password || "",
      isGoogle: isGoogle,
    ...
    if (result.success) {
      ...
      setTimeout(() => {
        navigate("/login", {
          state: {
            message:
              "Perfil criado com sucesso! Já pode fazer login com email e password.",
          },
        });
      }, 3000);
    } else {
            ...
            <Input
              ...
              onBlur={() => {
                ...
                if (!profileData.fazenda_nome)
                  setErrors((err) => ({
                    ...err,
                    fazenda_nome: "Nome da fazenda é obrigatório",
                  }));
              }}
        ...
        return (
          <>
            ...
            <div className="space-y-2">
              ...
              />
              {getFieldError("crmv") && (
                <p className="text-xs text-red-500">{getFieldError("crmv")}</p>
              )}
            </div>
          </>
        );
            ...
            <Input
              ...
              onBlur={() => {
                ...
                if (!profileData.setor)
                  setErrors((err) => ({
                    ...err,
                    setor: "Setor de trabalho é obrigatório",
                  }));
              }}
            ...
            <Input
              ...
              onBlur={() => {
                ...
                if (!profileData.area_atuacao)
                  setErrors((err) => ({
                    ...err,
                    area_atuacao: "Área de atuação é obrigatória",
                  }));
              }}
          ...
          <CardContent className="space-y-4">
            ...
            {isGoogle && (
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                <p className="text-sm text-blue-600 text-center">
                  📧 Registando com Google: {userData.email}
                </p>
              </div>
            )}
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-gray-400">
                Digite apenas os 9 dígitos (ex: 912345678)
              </p>
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-gray-400">
                Só aceitamos utilizadores maiores de 18 anos.
              </p>
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  <Input
                    ...
                    className={`pl-9 ${errors.confirm_password ? "border-red-500" : ""}`}
                    required
                  />
                  <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400" />
                </div>
